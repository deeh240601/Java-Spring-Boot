...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Rest Repositories HAL Explorer, Rest Repositories'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 beetechdemo:0.0.1-SNAPSHOT
```
